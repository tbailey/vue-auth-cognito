...
exports.default = (_types$AUTHENTICATE$t = {}, _defineProperty(_types$AUTHENTICATE$t, types.AUTHENTICATE, function (state, payload) {
  ...
  state.user = null;
}), _defineProperty(_types$AUTHENTICATE$t, types.ATTRIBUTES, function (state, payload) {
  state.user.attributes = payload;
}), _defineProperty(_types$AUTHENTICATE$t, types.COGNITOUSER, function (state, payload) {
  state.cognitoUser = payload;
}), _defineProperty(_types$AUTHENTICATE$t, types.REMOVECOGNITOUSER, function (state) {
